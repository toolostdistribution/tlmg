...
export const boardMembers: BoardMember[] = [
  {
    ...
    bio: [
      ...
      'Before co-founding Too Lost, Gregory worked at Sony Music Entertainment. Over the past decade, he has dedicated his career to building, investing in, and elevating artists, labels, and catalogs, helping shape the modern independent music economy.',
      'Gregory has been recognized as a Billboard 40 Under 40 honoree, a Billboard Indie Power Player, and a Forbes 30 Under 30 recipient. Under his leadership, Too Lost has been named one of Inc. Magazine\'s Top 100 Fastest-Growing Private Companies in America.',
      'In addition to his role at Too Lost, Gregory serves as a founding board member of the Music Fights Fraud Alliance, alongside directors from Believe, Downtown, Amazon, Spotify, and Meta. He also sits on the board of AntiFragile Equity Partners, a music catalog acquisition firm, and is a member of the American Association of Independent Music, Young Presidents\' Organization, and The Recording Academy.',
    ],
  },
  {
    name: 'Michael S. Berk',
...
export const leaders: Leader[] = [
  ...
  },
  {
    ...
    role: 'Director of Commercial Strategy, Too Lost Music Group',
  ...
  },
  {
    ...
    bio: [
      ...
      'A music industry entrepreneur and digital distribution specialist, Andy co-founded GYRO in Brisbane in 2018 after identifying a need for independent Australian artists to have greater access to local support, global distribution infrastructure and international growth opportunities. Under his leadership, GYRO developed from an artist-facing digital distributor into a diversified global music company operating across distribution, artist services, marketing, publishing and music technology.',
      ...
      'He has overseen the development of the broader GYRO Group portfolio, including boutique artist-services company Group Speed, instrumental music program Soothe Sounds and GYRO\'s publishing, synchronization and promotional operations. Through these businesses, Andy and his team have supported the careers of independent artists while building technology and infrastructure used by music companies across six continents.',
      'Before founding GYRO, Andy spent approximately a decade working across major and independent record labels, including Universal Music Group, developing experience in artist management, distribution and the broader recorded music business. He holds a degree from the University of Queensland.',
  ...
  },
  {
    ...
    slug: 'viv-melish',
    role: 'Chief Marketing Officer, GYRO Group · Director of Commercial Strategy APAC, Too Lost Music Group',
    ...
    bio: [
      ...
      'She has helped guide the development of DistroDirect, GYRO Group\'s white-label distribution technology platform, as well as Group Speed, Soothe Sounds and GYRO\'s broader marketing, publishing and synchronization capabilities. Across these businesses, Vivienne has worked to create stronger commercial and promotional opportunities for independent artists, labels and music entrepreneurs around the world.',
      'Before co-founding GYRO, Vivienne built a career across journalism, publicity, marketing and strategic communications, with experience spanning music, film, theatre, politics and major events. This multidisciplinary background continues to inform her approach to artist storytelling, audience development and brand strategy.',
      'Vivienne is also an active advocate for Australia\'s independent music community and serves as President of QMusic, Queensland\'s peak music-industry organization and the organization behind BIGSOUND and the Queensland Music Awards.',
  ...
  },
  {
    name: 'Adrian Burke',
    slug: 'adrian-burke',
    role: 'Executive Vice President of Artist Services, GYRO Group · Head of Group Speed',
  ...
  },
  {
    name: 'Nate Fisher',
    slug: 'nate-fisher',
    role: 'Vice President of Artist and Label Investments, Too Lost Music Group',
  ...
  },
  {
    name: 'Lucas Billig',
    slug: 'lucas-billig',
    role: 'Vice President of Operations, Too Lost Music Group',
